...
def get_immortal_jellyfish_fact() -> FactResponse:
    ...
    supporting = [
        ...
        Source(
            ...
            note="Overview of T. dohrnii's reversal ability for a general audience.",
        ),
    ]
    ...
    refuting = [
        ...
        Source(
            ...
            note="Contextualizes the immortality claim; death still occurs from external causes.",
        ),
    ]

    return FactResponse(
        fact=fact_text, supporting_sources=supporting, refuting_sources=refuting
    )
