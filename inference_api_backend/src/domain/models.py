...
class Source(BaseModel):
    ...
    note: Optional[str] = Field(
        None,
        description="Short note on how the source supports or refutes the fact",
    )
...
class FactResponse(BaseModel):
    ...
    supporting_sources: List[Source] = Field(
        ...,
        description="Sources that support the fact",
    )
    refuting_sources: List[Source] = Field(
        ...,
        description="Sources that refute or contextualize the claim",
    )
